...
package com.gacrnd.gcs.sourcecode.wm;
...
public final class ViewRootImpl implements ViewParent,
    ...
    // draw returns.
    private Transaction mRtBLASTSyncTransaction = new Transaction();
        ...
        synchronized (this) {
            if (mView == null) {
                ...
                mWindowAttributes.privateFlags |=
                        LayoutParams.PRIVATE_FLAG_USE_BLAST;
                ...
                if (DEBUG_KEEP_SCREEN_ON && (mClientWindowLayoutFlags
                        ...
                        && (attrs.flags& LayoutParams.FLAG_KEEP_SCREEN_ON) == 0) {
                ...
                if (!compatibilityInfo.supportsScreen()) {
                    attrs.privateFlags |= LayoutParams.PRIVATE_FLAG_COMPATIBLE_WINDOW;
    ...
    private void enableHardwareAcceleration(LayoutParams attrs) {
        ...
        final boolean hardwareAccelerated =
                (attrs.flags & LayoutParams.FLAG_HARDWARE_ACCELERATED) != 0;
        ...
        if (hardwareAccelerated) {
            ...
            final boolean fakeHwAccelerated = (attrs.privateFlags &
                    LayoutParams.PRIVATE_FLAG_FAKE_HARDWARE_ACCELERATED) != 0;
            final boolean forceHwAccelerated = (attrs.privateFlags &
                    LayoutParams.PRIVATE_FLAG_FORCE_HARDWARE_ACCELERATED) != 0;
    ...
    void setLayoutParams(LayoutParams attrs, boolean newView) {
        synchronized (this) {
            ...
            if ((changes & LayoutParams.TRANSLUCENT_FLAGS_CHANGED) != 0) {
                // Recompute system ui visibility.
                mAttachInfo.mRecomputeGlobalAttributes = true;
            }
            if ((changes & LayoutParams.LAYOUT_CHANGED) != 0) {
            ...
            if ((attrs.softInputMode & LayoutParams.SOFT_INPUT_MASK_ADJUST)
                    == LayoutParams.SOFT_INPUT_ADJUST_UNSPECIFIED) {
                mWindowAttributes.softInputMode = (mWindowAttributes.softInputMode
                        & ~LayoutParams.SOFT_INPUT_MASK_ADJUST)
                        | (oldSoftInputMode & LayoutParams.SOFT_INPUT_MASK_ADJUST);
            }
    ...
    private void applyKeepScreenOnFlag(LayoutParams params) {
        ...
        if (mAttachInfo.mKeepScreenOn) {
            ...
            params.flags = (params.flags&~LayoutParams.FLAG_KEEP_SCREEN_ON)
                    | (mClientWindowLayoutFlags& LayoutParams.FLAG_KEEP_SCREEN_ON);
        }
    }
    ...
    private boolean collectViewAttributes() {
        if (mAttachInfo.mRecomputeGlobalAttributes) {
            ...
            LayoutParams params = mWindowAttributes;
    ...
    @VisibleForTesting
    public static void adjustLayoutParamsForCompatibility(LayoutParams inOutParams) {
    ...
    private void controlInsetsForCompatibility(LayoutParams params) {
        if (sNewInsetsMode != NEW_INSETS_MODE_FULL) {
            return;
        }
    ...
    private boolean measureHierarchy(final View host, final LayoutParams lp,
    ...
    private static boolean shouldUseDisplaySize(final LayoutParams lp) {
    ...
    private void performTraversals() {
        ...
        mWillDrawSoon = true;
        boolean windowSizeMayChange = false;
        LayoutParams lp = mWindowAttributes;
        ...
        if (mFirst || mAttachInfo.mViewVisibilityChanged) {
            ...
            if (resizeMode == LayoutParams.SOFT_INPUT_ADJUST_UNSPECIFIED) {
                final int N = mAttachInfo.mScrollContainers.size();
                for (int i=0; i<N; i++) {
                    if (mAttachInfo.mScrollContainers.get(i).isShown()) {
                        resizeMode = LayoutParams.SOFT_INPUT_ADJUST_RESIZE;
                    }
                }
                if (resizeMode == 0) {
                    resizeMode = LayoutParams.SOFT_INPUT_ADJUST_PAN;
                }
                if ((lp.softInputMode &
                        LayoutParams.SOFT_INPUT_MASK_ADJUST) != resizeMode) {
        ...
        if (mAdded) {
            ...
            if (hasWindowFocus) {
                ...
                if (mAttachInfo.mThreadedRenderer != null && mSurface.isValid()) {
                    mFullRedrawNeeded = true;
                    try {
                        final LayoutParams lp = mWindowAttributes;
    ...
    private void performLayout(LayoutParams lp, int desiredWindowWidth,
                               int desiredWindowHeight) {
    ...
    private int relayoutWindow(LayoutParams params, int viewVisibility,
    ...
    Transaction getBLASTSyncTransaction() {
